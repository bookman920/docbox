...
```endpoint
GET http://localhost:17332/public/addr/:addr
```
...
```endpoint
GET http://localhost:17332/public/addr/:addr/utxo
```
...
```endpoint 
GET http://localhost:17332/public/addrs/:addrs/utxo
POST http://localhost:17332/public/addrs/utxo/{addrs}
```
...
```endpoint 
GET http://localhost:17332/public/addrs/:addrs/txs
POST http://localhost:17332/public/addrs/txs/{addrs}
```
...
```endpoint 
GET http://localhost:17332/public/addr/:addr/balance
```
...
```endpoint 
GET http://localhost:17332/public/addr/:addr/totalReceived
```
...
```endpoint 
GET http://localhost:17332/public/addr/:addr/totalSent
```
...
```endpoint 
GET http://localhost:17332/public/addr/:addr/unconfirmedBalance
```
